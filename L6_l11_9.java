...
public class Solution {
    ...
    public static class Cat {
        ...
        public String toString() {
            if ((parent1 == null) && (parent2 == null)) return "The cat's name is " + name + ", no mother, no father ";
            else if ((parent1 != null) && (parent2 == null)) return "The cat's name is " + name + ", mother is " + parent1.name + ", no father";
            else if ((parent1 == null) && (parent2 != null)) return "The cat's name is " + name + ", no mother" + ", father is " + parent2.name;
            else if ((parent1 != null) && (parent2 != null)) return "The cat's name is " + name + ", mother is " + parent1.name + ", father is " + parent2.name;
            else return null;
